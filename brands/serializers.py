...
from .models import  Merchandise, Cart, Leads, BrandDashboard, BillingAddress, MerchandiseAvailableSizes
...
class MerchandiseSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Merchandise
        fields = [
            'id','brand_name', 'merchandise_name', 'size_type',  'merchandise_gender',  'available_sizes', 'merchandise_type', 'labels', 'delivery_cost', 'category', 'merchandise_description', 'merchandise_details', 'price', 'display_image',
        ]
